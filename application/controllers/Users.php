...
class Users extends CI_Controller
{
	public function index()
	{
		...
		if (!isset($ceks)) {
			...
			$data['judul_web'] = "Beranda | E-Surat";
	...
	public function profile()
	{
		...
		if (!isset($ceks)) {
			...
			$data['judul_web'] 		= "Profile | E-Surat";
	...
	public function pengguna($aksi = '', $id = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($aksi == 't') {
				...
				$data['judul_web'] 	  = "Tambah Pengguna | E-Surat";
			} elseif ($aksi == 'd') {
				$p = "pengguna_detail";

				$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
				$data['judul_web'] 	  = "Detail Pengguna | E-Surat";
			} elseif ($aksi == 'e') {
				$p = "pengguna_edit";

				$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
				$data['judul_web'] 	  = "Edit Pengguna | E-Surat";
			} elseif ($aksi == 'h') {

				$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
				$data['judul_web'] 	  = "Hapus Pengguna | E-Surat";
				...
				$data['judul_web'] 	  = "Pengguna | E-Surat";
			}
	...
	public function bagian($aksi = '', $id = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($aksi == 't') {
				...
				$data['judul_web'] 	  = "Tambah Bagian | E-Surat";
			} elseif ($aksi == 'e') {
				$p = "bagian_edit";
				if ($data['user']->row()->level == 's_admin') {
					redirect('404_content');
				...
				$data['judul_web'] 	  = "Edit Bagian | E-Surat";
			} elseif ($aksi == 'h') {
				...
				$data['query'] = $this->db->get_where("tbl_bagian", array('id_bagian' => "$id"))->row();
				$data['judul_web'] 	  = "Hapus Bagian | E-Surat";
	...
	public function sm($aksi = '', $id = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($aksi == 't') {
				...
				$data['judul_web'] 	= "Tambah Surat Masuk | E-Surat";
			} elseif ($aksi == 'd') {
				$p = "sm_detail";
				$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id"))->row();
				$data['judul_web'] 	  = "Detail Surat Masuk | E-Surat";
				...
				$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id"))->row();
				$data['judul_web'] 	  = "Edit Surat Masuk | E-Surat";
			} elseif ($aksi == 'h') {
				if ($data['user']->row()->level == 's_admin' or $data['user']->row()->level == 'user') {
					redirect('404_content');
				}
				$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id", 'id_user' => "$id_user"))->row();
				$data['judul_web'] 	  = "Hapus Surat Masuk | E-Surat";
				...
				$p = "sm";
				$data['judul_web'] 	  = "Surat Masuk | E-Surat";
			}
	...
	public function sk($aksi = '', $id = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($aksi == 't') {
				...
				$data['judul_web'] 	  = "Tambah Surat Keluar | E-Surat";
			} elseif ($aksi == 'd') {
				$p = "sk_detail";

				$this->db->join('tbl_user', 'tbl_sk.id_user=tbl_user.id_user');
				$data['query'] = $this->db->get_where("tbl_sk", array('id_sk' => "$id"))->row();
				$data['judul_web'] 	  = "Detail Surat Keluar | E-Surat";
				...
				$data['judul_web'] 	  = "Edit Surat Keluar | E-Surat";
				...
				$data['query'] = $this->db->get_where("tbl_sk", array('id_sk' => "$id", 'id_user' => "$id_user"))->row();
				$data['judul_web'] 	  = "Hapus Surat Keluar | E-Surat";
				...
				$p = "sk";
				$data['judul_web'] 	  = "Surat Keluar | E-Surat";
			}
	...
	public function lap_sk()
	{
		...
		if (!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Keluar | E-Surat";
	...
	public function data_sk($tgl1 = '', $tgl2 = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($tgl1 != '' and $tgl2 != '') {
				...
				$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
				$data['judul_web'] = "Data Laporan Surat Keluar | E-Surat";
				$this->load->view('users/header', $data);
	...
	public function lap_sm()
	{
		...
		if (!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Masuk | E-Surat";
	...
	public function data_sm($tgl1 = '', $tgl2 = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($tgl1 != '' and $tgl2 != '') {
				...
				$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
				$data['judul_web'] = "Data Laporan Surat Masuk | E-Surat";
				$this->load->view('users/header', $data);
