...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<a class="navbar-brand" href="" style="color: #FFF;"><span class="glyphicon glyphicon-send" aria-hidden="true"></span><b>&nbsp;&nbsp;E-SURAT</b></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if ($sub_menu == "sk" or $sub_menu == "sm") {
									...
									<a href="#"><i class="icon-file-spreadsheet"></i> <span><b>ARSIP SURAT</b></span></a>
									<ul>
								...
								<li class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "lap_sm") {
									...
									<a href="#"><i class="icon-printer4"></i> <span><b>LAPORAN</b></span></a>
									<ul>
