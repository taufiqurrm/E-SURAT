...
if ($cek_ns->num_rows() == 0) {
  $no_surat       = "SK/" . date('Y') . "/MTs.BU/001";
} else {
  $noUrut          = substr($cek_ns->row()->no_surat, 13, 15);
  $noUrut++;
  $no_surat        = "SK/" . date('Y') . "/MTs.BU/" . sprintf("%03s", $noUrut);
}
?>
          ...
          <div class="panel-heading text-left">
            <div class="row">
              <div class="col-sm-6 text-left">
                <span class="glyphicon glyphicon-home" aria-hidden="true"></span><b>&nbsp; TAMBAH SURAT KELUAR</b><br>E-Surat
              </div>
            </div>
          </div>
                  ...
                  <div class="col-lg-4">
                    <div class="input-group">
                      ...
                      <select class="form-control" name="status" id="status" required>
                        ...
                        <option value="Kedalam">Kedalam</option>
                      </select>
                    </div>
                  </div>
                </div>
